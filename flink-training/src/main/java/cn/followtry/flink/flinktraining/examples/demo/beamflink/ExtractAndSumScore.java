 ...
 * @since 2019/6/29
 */
public class ExtractAndSumScore extends PTransform<PCollection<UserInfo>, PCollection<KV<String, Long>>> {
    ...
    @Override
    public PCollection<KV<String, Long>> expand(PCollection<UserInfo> input) {
        //自定义 combine 的方法实现自转换，Aggr.ofCnt()
        /**
